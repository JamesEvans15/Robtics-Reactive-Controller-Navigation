...
class sim_node(Node):
    def __init__(self):
        ...
        with open("/home/parallels/ros2_ws/src/project_4/project_4/worlds/ell.world") as f:
        ...
        self.robot = load_disc_robot('/home/parallels/ros2_ws/src/project_4/project_4/robots/bad.robot')
